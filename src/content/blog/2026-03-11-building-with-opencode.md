...
*This entire site - every line of code, every blog post, every test - was generated by AI. I didn't write a single line myself. What I did was guide the process: review outputs, catch bugs the models missed (like visual overlaps), provide feedback, and iterate until it worked.

The "AI coding assistant" narrative often implies humans are still doing the real work. Here's the truth: I just prompted, reviewed, and directed. The AI did everything else. And honestly? That's the future - not human-AI collaboration, but human direction of AI execution. Qwen3.5 Plus handled the heavy lifting; I just guided the process.*
